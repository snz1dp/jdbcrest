...
public class Swagger2Config {
  ...
  @Autowired
	...
	private ApiInfo apiInfo() {
		Contact contact = new Contact(version.getCompany_name(), version.getCompany_url(), version.getContact_email());
		return new ApiInfoBuilder()
		           .title(version.getProduct_name())
		           .description(version.getDescription())
		           .termsOfServiceUrl(version.getCompany_url())
		           .contact(contact)
